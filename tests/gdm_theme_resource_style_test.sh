...
assert_contains "${css}" "#lockDialogGroup {"
assert_contains "${css}" "background-color: rgba(4, 6, 10, 0.86);"
assert_contains "${css}" ".login-dialog-user-list-view .login-dialog-user-list .login-dialog-user-list-item {"
assert_contains "${css}" "background-color: rgba(255, 255, 255, 0.06);"
